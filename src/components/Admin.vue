                    ...
                    <ul>
                        ...
                        <li>
                            <router-link to="/admin/overview">
                                <font-awesome-icon  class="fa" icon="chartLine"/>
                                <span>Overview</span>
                            </router-link>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="/" @click="logout()">
                                <font-awesome-icon  class="fa" icon="poweroff"/>
                                <span>Logout</span>
                            </a>
                        </li>
                    </ul>
 ...
 @-webkit-keyframes swing {
  ...
  .chiller-theme .sidebar-wrapper {
    ...
    .chiller-theme .sidebar-wrapper .sidebar-menu li.active a i {
      color: #ffbe00;
      text-shadow: 0px 0px 10px rgba(255, 190, 0, 0.5); }
  ...
  .cool-theme .sidebar-wrapper {
    ...
    .cool-theme .sidebar-wrapper .sidebar-menu li.active a i {
      color: #fe6fff;
      text-shadow: 0px 0px 10px rgba(254, 111, 255, 0.5); }
  ...
  .ice-theme .sidebar-wrapper {
    ...
    .ice-theme .sidebar-wrapper .sidebar-menu li.active a i {
      color: #38fbc7;
      text-shadow: 0px 0px 10px rgba(56, 251, 199, 0.5); }
  ...
  .light-theme .sidebar-wrapper {
    ...
    .light-theme .sidebar-wrapper .sidebar-menu li.active a i {
      color: #00a9fd;
      text-shadow: 0px 0px 10px rgba(0, 169, 253, 0.5); }
