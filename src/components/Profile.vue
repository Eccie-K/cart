      ...
      <div class="container">
        ...
        <div class="intro h-100">
            <div class="row h-100 align-items-center">
              ...
              <div class="col-md-5">
                  <img src="https://lh3.googleusercontent.com/JZuNOv6A1t5ts3WvOeIiyedP5PWZb9PQhJXZlbTlf3kYh2UfUHQBhwDlmGQvoV4FF8w=w412-h220-rw" width="300" alt="" class="img-fluid">
              </div>
            </div>
          </div>
